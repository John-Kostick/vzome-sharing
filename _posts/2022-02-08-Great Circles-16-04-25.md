...
<video width="548" height="440" name="John Kostick's Three plane video" 
        controls loop muted>
...
4 planes composed of 6 circles each, surrounding a 7-axis star.
  ...
  <video width="548" height="440" name="John Kostick's Four plane video" 
        controls loop muted>
...
<video width="548" height="440" name="John Kostick's Four plane expanded video" 
        controls loop muted>
...
<video width="548" height="440" name="John Kostick's Four plane partially condensed video" 
        controls loop muted>
...
<video width="548" height="440" name="John Kostick's Four plane condensed video" 
        controls loop muted>
...
<video width="548" height="440" name="John Kostick's Six plane video" 
        controls loop muted>
  
<source src="[MVI_0716.mov.zip](https://github.com/John-Kostick/vzome-sharing/files/8135590/MVI_0716.mov.zip)">
...
<video width="548" height="440" name="John Kostick's Ten rings video" 
        controls loop muted>
...
<video width="548" height="440" name="John Kostick's Ten planes video" 
        controls loop muted>
...
<video width="548" height="440" name="John Kostick's Sixteen planes video" 
        controls loop muted>
