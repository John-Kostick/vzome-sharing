...
<figure style="width: 87%; margin: 5%">
 ...
 Scenes shows a sequence of skew orientations, some just as struts, i.e. not filled out.  They do represent structures that can be made with bypassing rods.  An image of one such structure is shown below.  It corresponds to the "After intersection" model.
