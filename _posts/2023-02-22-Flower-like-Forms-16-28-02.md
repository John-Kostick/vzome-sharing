...
The models below are related, but feature examples that only have two-fold symmetry.  This is less like actual flower forms, more about types of symmetry.  In Scenes, there are also 2 examples of four-fold compositions that are constructed half from available directions and half from mirrored copies of directions.  (Green plane mirrors)
