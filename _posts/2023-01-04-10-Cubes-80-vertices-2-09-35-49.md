...
Below is shown a compound of 4 cubes, which can be seen as a precursor of the 10 cube compound.  Scenes shows how a cube can be duplicated in a different orientation.  Here, the original grey cube is copied into a position that is rotated about the z axis by 45°, to generate the yellow cube. Likewise, rotating the original cube about the x and y axes generates a red and a blue cube respectively. This same process can reiterated, duplicating each of the generated cubes in 2 unique ways without any vertices coinciding, which is how the 10 cube compound is constructed. In that model, the pale blue cube generates pale green, yellow, and pink cubes.  Then, for example, the pale green cube generates a dark green and a grey cube, etc. Further rounds of duplications is possible.            
