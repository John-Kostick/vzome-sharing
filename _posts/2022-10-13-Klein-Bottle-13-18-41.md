...
A more complicated model is this, with six "tunnel" directions.  It has three-fold symmetry about only one axis, indicated with a yellow strut. Red struts from the center are indicators of open tunnels.  As with the above model, pentagonal "end caps" are left open for viewing.   
