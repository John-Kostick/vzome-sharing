...
{% endcomment %}
  ...
  Various ways that domes can be constructed.  [Geodesic Domes](https://en.wikipedia.org/wiki/Geodesic_dome) are mostly defined and/or built with icosahedral symmetry.  They can be seen as a subdivision of icosahedron, like this.
